    ...
    <ScrollView>
      <Container>
        <ProfileContainer>
          ...
          <ProfileText>
            {data?.me?.major} {mentor ? "" : "희망"}
          </ProfileText>
          <NameText>
            {data?.me?.name} {data?.me?.mentor ? "멘토" : "멘티"}님
          </NameText>
          <SubContainer>
          ...
          <SubContainer>
            ...
            <CheckBoxContainer>
              <CheckBox
                color={
                  data?.me?.field.includes("학습코칭") ? "#DDDDDD" : "white"
                }
              >
              ...
              <CheckBox
                color={
                  data?.me?.field.includes("대학입시") ? "#DDDDDD" : "white"
                }
              >
                <NormalText color="gray" size="14" weight="400">
                  대학{"\n"}입시
              ...
              <CheckBox
                color={data?.me?.field.includes("대학원") ? "#DDDDDD" : "white"}
              >
                <NormalText color="gray" size="14" weight="400">
                  대학원
                </NormalText>
              ...
              <CheckBox
                color={data?.me?.field.includes("편입") ? "#DDDDDD" : "white"}
              >
                <NormalText color="gray" size="14" weight="400">
                  편입
                </NormalText>
              ...
              <CheckBox
                color={
                  data?.me?.field.includes("진로전공") ? "#DDDDDD" : "white"
                }
              >
                <NormalText color="gray" size="14" weight="400">
                  진로{"\n"}전공
          ...
          <SubContainer>
            ...
            <MatchingInfoContainer>
              ...
              <MatchingInfoSmallContiner>
                ...
                <NormalText color="black" size="15" weight="400">
                  {data?.me?.counselPriceLow} ~ {data?.me?.counselPriceHigh}원
                </NormalText>
              </MatchingInfoSmallContiner>
            </MatchingInfoContainer>
          </SubContainer>
